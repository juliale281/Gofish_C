...
struct player {
    ...
    size_t hand_size;     // Number of cards in hand
    size_t max_hand_size; // Maximum size allocated for cards
    int book[7];          // Assuming maximum of 7 books
    size_t book_count;   // To keep track of how many books the player has
 ...
 */
const char* computer_play(struct player* target);
